...
class ClienteRepositoryTest {
    ...
    void configuraMassaDados(){
        ...
        testEntityManager.persist(new Cliente(null, "João", "942.965.820-46"));
        testEntityManager.persist(new Cliente(null, "Pedro", "209.562.500-50"));
        testEntityManager.persist(new Cliente(null, "Felipe", "553.388.570-65"));
        testEntityManager.persist(new Cliente(null, "Ana", "382.768.620-20"));
        testEntityManager.persist(new Cliente(null, "Gabriela", "590.167.870-20"));
        testEntityManager.persist(new Cliente(null, "Julia", "011.037.200-07"));
    }
    ...
    void deveRetornarPorCpfJuliaENomePedro(){
        ...
        Cliente clienteEsperadoJulia = new Cliente(6L, "Julia", "011.037.200-07");
        Cliente clienteEsperadoPedro = new Cliente(2L, "Pedro", "209.562.500-50");
